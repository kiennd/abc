...
public class KConstant {
	public static int METHOD_SEARCH_API = 0;
	...
	public static String ACTION_COMMAND_VIEW_LIB = "viewlib";
	public static String ACTION_COMMAND_ADD_LEARN_DATA = "ADDLEARNDATA";
